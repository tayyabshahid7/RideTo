...
const BikePicker = React.forwardRef(
  (
    ...
    if (
      ...
      (isAutoElectricFull && bike_hire === BIKE_HIRE.AUTO_ELECTRIC) ||
          ...
          <div className={isFullLicence && styles.bikeButtons}>
            ...
            {has_auto_bikes && (
              <button
                ...
                {!isCbtRenewal &&
                  course.auto_bikes_pricing > 0 &&
                  ` ( + £${course.auto_bikes_pricing / 100} )`}
            ...
            {has_auto_bikes_50cc && (
              <button
                ...
                {isCbtRenewal && ` £${course.bike_hire_cost / 100}`}
                {!isCbtRenewal &&
                  course.auto_bikes_50cc_pricing > 0 &&
                  ` ( + £${course.auto_bikes_50cc_pricing / 100} )`}
            ...
            {!isFullLicence && has_auto_bikes_125cc && (
              <button
                ...
                {isCbtRenewal && ` £${course.bike_hire_cost / 100}`}
                {!isCbtRenewal &&
                  course.auto_bikes_125cc_pricing > 0 &&
                  ` ( + £${course.auto_bikes_125cc_pricing / 100} )`}
            ...
            {!isFullLicence && has_manual_50cc && (
              <button
                ...
                {isCbtRenewal && ` £${course.bike_hire_cost / 100}`}
                {!isCbtRenewal &&
                  course.manual_bikes_50cc_pricing > 0 &&
                  ` ( + £${course.manual_bikes_50cc_pricing / 100} )`}
