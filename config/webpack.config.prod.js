...
const publicPath = process.env.FRONT_END_BASE_URL || paths.servedPath
...
const cssFilename = 'client/css/[name].css'
...
module.exports = {
  ...
  output: {
    ...
    chunkFilename: 'client/js/[name].[chunkhash:8].chunk.js',
  ...
  plugins: [
    ...
    // Creates a server at http://127.0.0.1:8888/ to visualize size of webpack
    // output files with an interactive zoomable treemap.
